...
\chapter{Mechanik}
	...
	\section{Motorbefestigung}\label{sec:motorbefestigung}
		...
		Die Verbindung zwischen Motor und Hangar wird in zwei Teilen hergestellt: eine Scheibe, die formschlüssig Verdrehen um die Hangerachse und durch Verspannen reibschlüssig Verschieben entlang der Hangerachse verhindert.
	...
	\section{Transmission}\label{sec:transmission}
		...
		\begin{figure}[h]
			\centering
			\includesvg[width=.4\textwidth]{Footage/AwesomeBoard Transmission CAD/Drawings/Orangatang Kegel 83mm Longboard Wheel}
			\caption[Rückansicht der \textit{Kegel} des Herstellers \textit{Orangatang}]{Rückansicht der \textit{Kegel} des Herstellers \textit{Orangatang}.}
			\label{fig:kegels}
		\end{figure}
		...
		\begin{figure}[h]
			\centering
			\includesvg[width=.6\textwidth, inkscapelatex=false]{Footage/AwesomeBoard Transmission CAD/Drawings/Orangatang Kegel Flat Face}
		...
		% \begin{figure}[h]
		% 	\centering
		% 	\includesvg[width=.7\textwidth]{Footage/AwesomeBoard Transmission CAD/Drawings/Wheels assembly}
		% 	\caption{Caption}
		% 	\label{fig:wheel assembly}
		% \end{figure}