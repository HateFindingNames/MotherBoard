...
\chapter{Mechanik}
	...
	Seine breite Zahnung bietet einen guten Kompromiss aus Flexibilität, Kraftübertrag \cite{gates.catalogue.2021}
		\begin{figure}[h]
			\centering
			\includesvg[width=.7\textwidth, inkscapelatex=false]{Footage/AwesomeBoard Transmission CAD/Drawings/HTD Parametric Pulley}
