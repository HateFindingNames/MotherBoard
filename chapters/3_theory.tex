...
\chapter{Theorie}
	...
	\begin{equation}
		F_\text{Hang} = m \cdot g \cdot \sin\left(\arctan\left(\frac{\angle}{100}\right)\right)
	...
	\begin{align}
		T_\text{Hang}	&= \left(F_\text{Hang} + F_\text{Roll} + F_\text{Ström}\right) \cdot r \nonumber \\
						&= \left[ m \cdot g \left( \sin\left(\arctan\left(\frac{\angle}{100}\right)\right) + c_\text{Roll} \right) + \frac{1}{2} \cdot \rho \cdot A \cdot c_\text{Ström} \cdot v^2 \right] \cdot r%
